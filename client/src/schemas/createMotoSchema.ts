...
export const createMotoSchema = z.object({
  ...
  descTitle: z.string().min(3, "Tytuł opisu musi mieć min. 3 litery"),
  secondaryDesc: z.string().min(10, "Dodatkowy opis musi mieć min. 10 liter"),
  klauzula: z.string().min(10, "Klauzula musi mieć min. 10 liter"),
  maxPower: z.number(),
...
export type createMoto = z.infer<typeof createMotoSchema>;